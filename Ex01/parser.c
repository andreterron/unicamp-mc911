...
{
       0,    49,    49,    50,    54,    55,    56,    61,    64,    68,
      77,    78,    82,    83,    88,    96,    97
};
#endif
...
{
  "$end", "error", "$undefined", "T_STRING", "T_SELECT", "T_FROM",
  "T_CREATE", "T_TABLE", "T_INSERT", "T_INTO", "T_VALUES", "';'", "'*'",
  "'('", "')'", "','", "$accept", "stmt_list", "stmt", "select_stmt",
  "create_stmt", "select_col_list", "col_list", "insert_stmt",
  "values_list", YY_NULLPTR
};
#endif
...
{
       0,    -1,    -4,     5,     1,    -6,     4,     6,     7,    -6,
      11,    -5,    16,    17,    -6,    -6,    -6,    -6,    -6,    18,
      19,    20,    12,    14,    -6,    -6,    -6,    23,    15,    -6,
      -2,    24,    -6,    26,    21,    22,    25,    -6,    27,    -6,
      28
};
...
{
       0,     0,     0,     0,     0,     3,     0,     0,     0,    10,
       0,     0,     0,     0,     1,     2,     6,     4,     5,     0,
       0,     0,     0,     0,     7,     8,    11,     0,     0,    12,
       0,     0,     9,     0,    12,     0,     0,    13,     0,    14,
      13
};
...
{
      20,    14,     9,    12,     1,     1,     2,     2,     3,     3,
      21,    10,    32,    33,    13,    16,    19,    17,    18,    22,
      23,    24,    25,    26,    28,    27,    29,    34,    31,    37,
      40,     0,     0,    15,    35,   -15,     0,    38,     0,    39,
       0,     0,   -16
};
...
{
       5,     0,     3,     7,     4,     4,     6,     6,     8,     8,
      15,    12,    14,    15,     9,    11,     5,    11,    11,     3,
       3,     3,     3,     3,    10,    13,     3,     3,    13,     3,
       3,    -1,    -1,     4,    31,    14,    -1,    15,    -1,    14,
      -1,    -1,    14
};
...
{
       0,     4,     6,     8,    17,    18,    19,    20,    23,     3,
      12,    21,     7,     9,     0,    18,    11,    11,    11,     5,
       5,    15,     3,     3,     3,     3,     3,    13,    10,     3,
      22,    13,    14,    15,     3,    22,    24,     3,    15,    14,
       3
};
...
#line 61 "parser.y" /* yacc.c:1646  */
    {
								(yyval.str) = concat(5, "\nSELECT '*' FROM ", (yyvsp[0].str), ":\n", selectFromTable((yyvsp[0].str)), "\n");
								}
...
#line 64 "parser.y" /* yacc.c:1646  */
    { (yyval.str) = concat(7, "\nSELECT ", colListToString((yyvsp[-2].list_col)), " FROM ", (yyvsp[0].str), ":\n", selectCols((yyvsp[0].str), (yyvsp[-2].list_col)), "\n\n"); }
#line 1281 "parser.c" /* yacc.c:1646  */
    break;

  case 9:
#line 68 "parser.y" /* yacc.c:1646  */
    {	FILE *F = fopen((yyvsp[-3].str), "w"); 
								fprintf(F, "%s\n", (yyvsp[-1].str));
								fclose(F);
								(yyval.str) = concat(5, "\nCREATE TABLE: ", (yyvsp[-3].str), "\nCOL_NAME: ", (yyvsp[-1].str), "\n\n");
							}
...
#line 77 "parser.y" /* yacc.c:1646  */
    { (yyval.list_col) = createColumn((yyvsp[0].str), NULL); }
#line 1297 "parser.c" /* yacc.c:1646  */
    break;

  case 11:
#line 78 "parser.y" /* yacc.c:1646  */
    { (yyval.list_col) = createColumn((yyvsp[0].str), (yyvsp[-2].list_col)); }
...
#line 83 "parser.y" /* yacc.c:1646  */
    { (yyval.str) = concat(3, (yyvsp[-2].str), ";", (yyvsp[0].str)); }
#line 1315 "parser.c" /* yacc.c:1646  */
    break;

  case 14:
#line 88 "parser.y" /* yacc.c:1646  */
    { FILE *F = fopen((yyvsp[-4].str), "a"); 
								  fprintf(F, "%s\n", (yyvsp[-1].str));
								  fclose(F);
								  (yyval.str) = concat(5, "\nINSERT INTO TABLE: ", (yyvsp[-4].str), "\nVALUES: ", (yyvsp[-1].str), "\n\n");
							 	}
